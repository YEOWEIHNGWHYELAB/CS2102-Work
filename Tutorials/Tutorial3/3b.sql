...
CREATE TABLE Patients (
	ssn TEXT PRIMARY KEY,
	physician TEXT NOT NULL REFERENCES Doctors, -- Must have a doctor. 
	name TEXT,
	address TEXT,
	age INTEGER
);
...
CREATE TABLE Prescribes (
	...
	pcname TEXT REFERENCES PharmaceuticalCompanies
		ON DELETE CASCADE, -- Because Drugs is a weak entity, its Owner Primary Key needs to be included. 
	tradename TEXT,
	pdate DATE,
	qty INTEGER,
