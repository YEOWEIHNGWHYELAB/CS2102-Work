...
CREATE TABLE Offices (
	...
	uname varchar(50) NOT NULL UNIQUE REFERENCES Workers (uname), /* Manager */
...
CREATE TABLE Bid (
	...
	FOREIGN KEY (ctuname, s_date, s_time, e_time)
	REFERENCES Availability (uname, s_date, s_time, e_time),
